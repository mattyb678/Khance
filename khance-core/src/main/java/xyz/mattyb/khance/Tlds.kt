...
internal val brandTlds = listOf(
        "aaa", "aarp", "abarth", "abb", "abbott", "abbvie", "abc", "accenture", "aco", "aeg",
        "aetna", "afl", "agakhan", "aig", "aigo", "airbus", "airtel", "akdn", "alfaromeo",
        "alibaba", "alipay", "allfinanz", "allstate", "ally", "alstom", "amazon",
        "americanexpress", "amex", "amica", "android", "anz", "aol", "apple", "aquarelle",
        "aramco", "audi", "auspost", "axa", "azure", "baidu", "bananarepublic", "barclaycard",
        "barclays", "basketball", "bauhaus", "bbc", "bbt", "bbva", "bcg", "bentley", "bharti",
        "bing", "blanco", "bloomberg", "bms", "bmw", "bnl", "bnpparibas", "boehringer", "bond",
        "booking", "bosch", "bostik", "bradesco", "bridgestone", "brother", "bugatti", "cal",
        "calvinklein", "canon", "capitalone", "caravan", "cartier", "cba", "cbn", "cbre", "cbs",
        "cern", "cfa", "chanel", "chase", "chintai", "chrome", "chrysler", "cisco", "citadel",
        "citi", "citic", "clubmed", "comcast", "commbank", "creditunion", "crown", "crs", "csc",
        "cuisinella", "dabur", "datsun", "dealer", "dell", "deloitte", "delta", "dhl", "discover",
        "dish", "dnp", "dodge", "dunlop", "dupont", "dvag", "edeka", "emerck", "epson", "ericsson",
        "emi", "esurance", "etisalat", "eurovision", "everbank", "extraspace", "fage", "fairwinds",
        "farmers", "fedex", "ferrari", "ferrero", "fiat", "fidelity", "firestone", "firmdale",
        "flickr", "flir", "flsmidth", "ford", "fox", "fresenius", "forex", "frogans", "frontier",
        "fujitsu", "fujixerox", "gallo", "gallup", "gap", "gbiz", "gea", "genting", "giving",
        "gle", "globo", "gmail", "gmo", "gmx", "godaddy", "goldpoint", "goodyear", "goog",
        "google", "grainger", "guardian", "gucci", "hbo", "hdfc", "hdfcbank", "hermes",
        "hisamitsu", "hitachi", "hkt", "honda", "honeywell", "hotmail", "hsbc", "hughes", "hyatt",
        "hyundai", "ibm", "ieee", "ifm", "ikano", "imdb", "infiniti", "intel", "intuit",
        "ipiranga", "iselect", "itau", "itv", "iveco", "jaguar", "java", "jcb", "jcp", "jeep",
        "jpmorgan", "juniper", "kddi", "kerryhotels", "kerrylogistics", "kerryproperties", "kfh",
        "kia", "kinder", "kindle", "komatsu", "kpmg", "kred", "kuokgroup", "lacaixa", "ladbrokes",
        "lamborghini", "lancaster", "lancia", "lancome", "landrover", "lanxess", "lasalle",
        "latrobe", "lds", "leclerc", "lego", "liaison", "lexus", "lidl", "lifestyle", "lilly",
        "lincoln", "linde", "lipsy", "lixil", "locus", "lotte", "lpl", "lplfinancial", "lundbeck",
        "lupin", "macys", "maif", "man", "mango", "marriott", "maserati", "mattel", "mckinsey",
        "metlife", "microsoft", "mini", "mit", "mitsubishi", "mlb", "mma", "monash", "mormon",
        "moto", "movistar", "msd", "mtn", "mtr", "mutual", "nadex", "nationwide", "natura", "nba",
        "nec", "netflix", "neustar", "newholland", "nexus", "nfl", "nhk", "nico", "nike", "nikon",
        "nissan", "nissay", "nokia", "northwesternmutual", "norton", "nra", "ntt", "obi", "office",
        "omega", "oracle", "orange", "otsuka", "ovh", "panasonic", "pccw", "pfizer", "philips",
        "piaget", "pictet", "ping", "pioneer", "play", "playstation", "pohl", "politie", "praxi",
        "prod", "progressive", "pru", "prudential", "pwc", "quest", "qvc", "redstone", "reliance",
        ...
        "verisign", "vig", "viking", "virgin", "visa", "vista", "vistaprint", "vivo", "volkswagen",
        "volvo", "walmart", "walter", "weatherchannel", "weber", "weir", "williamhill", "windows",
        "wme", "wolterskluwer", "woodside", "wtc", "xbox", "xerox", "xfinity", "yahoo", "yamaxun",
        "yandex", "yodobashi", "youtube", "zappos", "zara", "zip", "zippo"
)

internal val specialUseTlds = listOf(
